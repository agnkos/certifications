...
- [Manage Application State with Mobx-state-tree – Michel Weststrate](https://egghead.io/courses/manage-application-state-with-mobx-state-tree)  
- [Node.js Crash Course – Brad Traversy (YouTube)](https://www.youtube.com/results?search_query=nodejs+crash+course+brad+traversy)  
- [*Ultimate TypeScript Course 2024 All-in, Learn, Build and Excel* – O’Reilly / Packt Publishing, SkillZone (4h45m)](https://www.oreilly.com/videos/ultimate-typescript-course/9781837027019/)  
- [Modernize State Management in Angular with Signals (Egghead)](https://egghead.io/courses/modernize-state-management-in-angular-with-signals-6e7ea1c2)  
- [Intro to AI Engineering (Scrimba)](https://scrimba.com/intro-to-ai-engineering-c032)  
- [Learn LangChain.js (Scrimba)](https://scrimba.com/learn-langchainjs-c02t)  
- LLMs for developers: usage and integration practices – an internal company course  
